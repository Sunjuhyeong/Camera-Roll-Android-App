...
public class SearchActivity extends ThemeableActivity
                    ...
                    .addOnGlobalLayoutListener(
                            new ViewTreeObserver.OnGlobalLayoutListener() {
                                ...
                                public void onGlobalLayout() {
                                    ...
                                    // somewhat works...
                                    int[] screenSize = Util.getScreenSize(SearchActivity.this);
        ...
        MediaProvider.loadAlbum(this, path,
                new MediaProvider.OnAlbumLoadedCallback() {
                    ...
                    public void onAlbumLoaded(Album album) {
                        SearchActivity.this.album = album;
                        SearchActivity.this.onAlbumLoaded(savedInstanceState);
                    }
                });
    ...
    public void onActivityReenter(int requestCode, Intent data) {
        ...
        Log.d("SearchActivity", "onActivityReenter: " + this);
        if (data != null) {
                                    ...
                                    public void onMediaLoaded(ArrayList<Album> albums) {
                                        ...
                                        MediaProvider.loadAlbum(activity, newFilePath,
                                                new MediaProvider.OnAlbumLoadedCallback() {
                                                    ...
                                                    public void onAlbumLoaded(Album album) {
                                                        SearchActivity.this.album = album;
                                                        SearchActivity.this.onAlbumLoaded(null);
                                                    }
                                                });
                                    }
        ...
        if (!pick_photos) {
            ...
            new Handler().postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                        AnimatedVectorDrawable drawable = (AnimatedVectorDrawable)
                                ContextCompat.getDrawable(SearchActivity.this,
                                        R.drawable.cancel_to_back_avd);
                        //mutating avd to reset it
                        drawable.mutate();
                        d = drawable;
                    } else {
                        d = ContextCompat.getDrawable(SearchActivity.this,
    ...
    public void deleteSelectedItems() {
        ...
        final String[] selected_items = recyclerViewAdapter
                .cancelSelectorMode(SearchActivity.this);
        new AlertDialog.Builder(SearchActivity.this, theme.getDialogThemeRes())
            ...
            public void onReceive(Context context, Intent intent) {
                switch (intent.getAction()) {
                    ...
                    case DATA_CHANGED:
                        ...
                        MediaProvider.loadAlbum(SearchActivity.this, albumPath,
                                new MediaProvider.OnAlbumLoadedCallback() {
                                    @Override
                                    public void onAlbumLoaded(Album album) {
                                        SearchActivity.this.album = album;
    ...
    private void removeAlbumItem(String path) {
        Log.d("SearchActivity", "removeAlbumItem() called with: path = [" + path + "]");
        int index = -1;
        for (int i = 0; i < album.getAlbumItems().size(); i++) {
        ...
        Log.d("SearchActivity", "removeAlbumItem: " + index);
        if (index > -1) {
